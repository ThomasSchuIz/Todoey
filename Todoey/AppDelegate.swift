...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    // Lazy variables are variables that are stored/used ONLY when they're needed
    // NSPersistentContainer is pretty much a SQLite database, it's not limited to SQLite
    // it could also be an XML database, etc
